<!DOCTYPE html>
<html>
{{-- template utama utk admin n organizer, pke sidebar --}}
...
<body class="font-sans antialiased bg-gray-100 text-blue-1">
    <div x-data="{ isSidebarOpen: true }" class="flex">
        ...
        <div :class="isSidebarOpen ? 'w-64' : 'w-20'"
            class="bg-blue-1 text-white h-screen sticky top-0 h-screen flex flex-col transition-all duration-300">
            ...
            <nav class="flex-1">
                <div class="mt-10">
                    ...
                    <a href="{{ route('manage-events') }}"
                        :class="isSidebarOpen ? 'flex items-center py-3 px-6' : 'flex justify-center py-4 px-6'"
                        class="flex items-center hover:bg-blue-0 {{ request()->routeIs('events.index') ? 'bg-blue-0' : 'explore-events' }} text-white">
                        <i class="fas fa-calendar-alt"></i>
                ...
                <div class="mt-10">
                    ...
                    <form method="POST" action="{{ route('logout') }}">
                        @csrf
                        <button type="submit"
                            :class="isSidebarOpen ? 'flex items-center py-3 px-6 w-full' : 'flex justify-center py-4 px-6 w-full'"
        ...
        <!-- Main Content -->
        <div class="flex-1">
            <div class="flex py-6 px-10 justify-between items-center shadow-md">
